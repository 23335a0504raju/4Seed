...
$result = mysqli_query($con, "SELECT * FROM farmer_details");
?>
<html>
<head>
<style>
...
echo "<tr>";
echo"<td>".$row['f_name'];echo"</td>";
echo"<td>".$row['phnum'];echo"</td>";
echo"<td>".$row['land'];echo"</td>";
echo"<td>".$row['pincode'];echo"</td>";
echo"<td>".$row['state'];echo"</td>";
echo"<td>".$row['city'];echo"</td>";
echo"<td>".$row['house'];echo"</td>";
